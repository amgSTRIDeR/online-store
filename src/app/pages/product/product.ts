...
export class ProductPage {
    static pageRender(productId: number) {
        ...
        addDiscordButton.textContent = `${
            cart.getNumberOfItemsInCart(productId) === 0
                ? 'Добавить в корзину'
                : 'Убрать из корзины'
        }`;
        ...
        productWrapper.appendChild(breadCrumps);
        productWrapper.appendChild(about);
        ...
        if (mainSection) {
            ...
            mainSection.appendChild(productWrapper);
        }

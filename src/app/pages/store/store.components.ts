...
for (let i = 0; i < 20; i += 1) {
    card = new CardComponent({
        template: `
      <div class="card">
    <h3 class="card__title">Древний ужас</h3>
    <p class="card__subtitle">Конец света близок</p>
    <img class="card__image" src="./assets/images/game-collection-thumbnails/Arnaks.png" alt="">
    <button class="card__button">
      <p class="card__price"><span class="card__price-old">150$</span> 130$</p>
...
// export const card1 = new CardComponent({
